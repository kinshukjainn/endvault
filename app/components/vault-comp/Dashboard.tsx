      ...
      <header className="sticky top-0 z-20 pt-10 bg-black">
        <div className="max-w-6xl mx-auto px-4 py-4 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <button
              onClick={openAdd}
              className="hidden md:flex items-center gap-2 px-3 py-3 bg-[#252525] cursor-pointer text-white text-[15px] font-bold rounded-full transition-colors flex-shrink-0"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {visible.map((item) => {
              ...
              return (
                <div
                  key={item.id}
                  className="flex flex-col p-4 bg-[#161616]  rounded-3xl transition-colors"
                >
...
function IconBtn({
  ...
  return (
    <button
      title={title}
      onClick={onClick}
      className="p-1.5 rounded-lg cursor-pointer text-gray-400 hover:text-white  hover:bg-[#2B2A33] transition-colors flex items-center justify-center"
    >
      {children}
    </button>
  );
